...
class TestLoginCourier:
    ...
    def test_courier_can_login(self, create_test_courier):
        ...
        with allure.step("Отправить запрос на авторизацию с правильными данными"):
            payload = {
    ...
    @allure.title("Тест: авторизация без пароля возвращает ошибку")
    ...
    @allure.title("Тест: авторизация без логина возвращает ошибку")  
    def test_login_without_login_returns_error(self, create_test_courier):
        courier_data = create_test_courier
    ...
    def test_login_with_wrong_login_returns_error(self, create_test_courier):
        ...
        with allure.step("Попытаться авторизоваться с неправильным логином"):
            payload = {
    ...
    def test_login_nonexistent_user_returns_error(self):
        with allure.step("Попытаться авторизоваться под несуществующим пользователем"):
            payload = {
    ...
    def test_successful_login_returns_id(self, create_test_courier):
        ...
        with allure.step("Отправить запрос на авторизацию и проверить наличие id"):
            payload = {
                "login": courier_data["login"],
                "password": courier_data["password"]
            }
